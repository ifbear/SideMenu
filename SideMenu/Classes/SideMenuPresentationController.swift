...
internal final class SideMenuPresentationController {
    ...
    deinit {
        guard presentedViewController?.side.isHidden == false else { return }
    ...
    func containerViewWillLayoutSubviews() {
        ...
        presentedViewController.view.side.untransform {
            presentedViewController.view.frame = frameOfPresentedViewInContainerView
        }
        presentingViewController.view.side.untransform {
    ...
    func dismissalTransitionDidEnd(_ completed: Bool) {
        ...
        removeStyles(from: presentingViewController.side.containerViewController.view)
...
private extension SideMenuPresentationController {
    ...
    func transition(to: UIViewController, from: UIViewController, alpha: CGFloat, statusBarAlpha: CGFloat, scale: CGFloat, translate: CGFloat) {
        ...
        let x = (leftSide ? 1 : -1) * UIScreen.main.bounds.width * translate
